...
public class CadastroCliente extends javax.swing.JFrame {
    ...
    private Boolean validacoes(){
        ...
        if (jTextFieldCPF.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "O campo CPF deve se preenchido.");
    ...
    private void initComponents() {
        ...
        jLabelTermos = new javax.swing.JLabel();
        ...
        jComboBoxCidade.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cianorte", "Campo Mourão", "Londrina", "Maringá", " " }));
        ...
        jLabelTermos.setText("Aceito os termos de utilização do sistema ");
    ...
    private javax.swing.JLabel jLabelTermos;
